...
export default function AdminLayout() {
  return (
    ...
    <div className="flex h-screen w-full bg-[#3D2B1F] overflow-hidden font-barlow relative">
      ...
      <aside className="w-24 shrink-0 bg-[#2B1D14] border-r border-white/10 z-20 shadow-2xl">
        <Sidebar />
      </aside>
      ...
      <div className="flex flex-col flex-1 min-w-0 overflow-hidden px-8 py-4 relative z-10">
        ...
        <main className="flex-1 overflow-y-auto scrollbar-hide mt-4 bg-[#4E3B2F]/60 backdrop-blur-md rounded-[40px] p-8 border border-white/10 shadow-2xl">
