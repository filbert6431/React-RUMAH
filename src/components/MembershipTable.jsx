                ...
                return (
                  <tr key={member.id} className="border-t border-white/[0.02] hover:bg-white/[0.02] transition-all group">
                    ...
                    <td className="p-8 text-center">
                      <span
                        className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg border transition-all duration-300 ${
                          tier === "Platinum"
